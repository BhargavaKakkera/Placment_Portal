...
from .. import crud
from ..config import DEBUG, ENABLE_RATE_LIMITING, MAX_LOGIN_ATTEMPTS, LOGIN_ATTEMPT_WINDOW_SECONDS
from ..schemas import (
    RegisterIn,
    RegisterOut,
    Token,
...
from ..exceptions import ConflictError, AuthenticationError, TokenError, DatabaseError
...
def _send_email_verification_email(email: str, token: str) -> None:
    ...
    """
    logger.info(f"Email verification queued for: {email}")
